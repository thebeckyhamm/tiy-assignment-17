...
this["JST"]["repo"] = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return "<div class=\"repo flex space-between\">\n    <div>\n        <a href=\""
    ...
    + "</p>\n        <p class=\"text-light-muted\">Updated "
    + escapeExpression(((helper = (helper = helpers.pushed_at || (depth0 != null ? depth0.pushed_at : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"pushed_at","hash":{},"data":data}) : helper)))
